...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `dynatrace` with the `NAME` of your provider.
...
- binary: pulumi-resource-dynatrace
  ...
  ignore: []
  ldflags:
  - -X github.com/ivanalmendros/pulumi-dynatrace/provider/pkg/version.Version={{.Tag}}
...
├── config.yaml
├── metadata.json
├── pulumi-dynatrace_darwin_amd64_v1
│   └── pulumi-resource-dynatrace
├── pulumi-dynatrace_darwin_arm64
│   └── pulumi-resource-dynatrace
├── pulumi-dynatrace_linux_amd64_v1
│   └── pulumi-resource-dynatrace
├── pulumi-dynatrace_linux_arm64
│   └── pulumi-resource-dynatrace
├── pulumi-dynatrace_windows_amd64_v1
│   └── pulumi-resource-dynatrace.exe
└── pulumi-dynatrace_windows_arm64
    └── pulumi-resource-dynatrace.exe
```
