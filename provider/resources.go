...
import (
	...
	_ "embed"
    	...
    	"github.com/ivanalmendros/pulumi-dynatrace/provider/pkg/version"
)
...
const (
	...
	mainPkg = "dynatrace"
	// modules:
	mainMod = "index" // the dynatrace module
)
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		P:       shimv2.NewProvider(dynatrace.New(version.Version)()),
		Name:    "dynatrace",
		...
		Keywords:   []string{"pulumi", "dynatrace", "category/cloud"},
		License:    "Apache-2.0",
		Homepage:   "https://www.pulumi.com",
		Repository: "https://github.com/ivanalmendros/pulumi-dynatrace",
